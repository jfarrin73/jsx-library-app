...
public class User implements Serializable {
    ...
    public User(Long id, String userId, String firstName, String lastName, String username, String password, String email, LocalDate lastLoginDate, LocalDate lastLoginDateDisplay, LocalDate joinDate, String roles, String[] authorities, boolean isActive, boolean isNotLocked) {
        this.id = id;
        this.userId = userId;
